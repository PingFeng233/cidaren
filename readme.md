...
# 注意 注意 注意  竞赛一定要慢点做  拖时间  做太快会检测作弊
# 填空题自动复制到剪切版  直接粘贴就好了
# 测试稳定 支持竞赛。
...
![](https://gitee.com/lNeverl/pic/raw/master/20200411092329.png)

将https下的 decryot https traffic 和 ignore server certificate （unsafe） 勾选，会提示安装证书，全部同意，点击“是”。
![](https://gitee.com/lNeverl/pic/raw/master/20200411092443.png)

2配置fiddler脚本，打开Fidderscript
...
4.此时打开词达人开始做题，可以看到fiddler开始抓包了，最新的抓到的词达人的数据，在最下边。一定要找到词达人的包，词达人的包具有如下特点：(1)第一列图标为绿色箭头指向右边。第四列`host`为`wap.vocabgo.com`。

![](https://gitee.com/lNeverl/pic/raw/master/20200411094418.png)
双击框住的部分。可以看到右边已经出现解包的信息了，`Ture`的就是正确答案。
